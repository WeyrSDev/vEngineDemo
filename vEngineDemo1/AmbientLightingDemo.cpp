...
namespace Rendering
{
	...
	AmbientLightingDemo::AmbientLightingDemo(Engine& game, Camera& camera)
	...
	void AmbientLightingDemo::Update(const Time& gameTime)
	{
		UpdateAmbientLight(gameTime);
	}

	void AmbientLightingDemo::Draw(const Time& gameTime)
	{
	...
	void AmbientLightingDemo::UpdateAmbientLight(const Time& gameTime)
	{
