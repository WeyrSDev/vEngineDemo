...
namespace Rendering
{
	...
	DiffuseLightingDemo::DiffuseLightingDemo(Engine& game, Camera& camera)
	...
	void DiffuseLightingDemo::Update(const Time& gameTime)
	{
	...
	void DiffuseLightingDemo::Draw(const Time& gameTime)
	{
	...
	void DiffuseLightingDemo::UpdateDirectionalLight(const Time& gameTime)
	{
	...
	void DiffuseLightingDemo::UpdateAmbientLight(const Time& gameTime)
	{
