...
namespace Rendering
{
	...
	PointLightDemo::PointLightDemo(Engine& game, Camera& camera)
		: DrawableComponent(game, camera), mEffect(nullptr), mMaterial(nullptr), mTextureShaderResourceView(nullptr),
	...
	void PointLightDemo::Initialize()
	{
		...
		if (FAILED(hr))
		{
			throw Exception("CreateDDSTextureFromFile() failed.", hr);
		}
	...
	void PointLightDemo::Update(const Time& gameTime)
	{
	...
	void PointLightDemo::Draw(const Time& gameTime)
	{
	...
	void PointLightDemo::UpdateSpecularLight(const Time& gameTime)
	{
	...
	void PointLightDemo::UpdatePointLight(const Time& gameTime)
	{
	...
	void PointLightDemo::UpdateAmbientLight(const Time& gameTime)
	{
